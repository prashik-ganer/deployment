    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_pic', models.ImageField(blank=True, default='https://res.cloudinary.com/dbvh7sfop/image/upload/v1609412216/media/kkhypdgpvhg2b7pjp27m.png', null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('seller_profile_pic', models.ImageField(blank=True, default='default_profile.png', null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_created', models.DateTimeField(auto_now_add=True, null=True)),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Packed', 'Packed'), ('Delivered', 'Delivered')], max_length=200, null=True)),
